...
Date.longFormat = "dddd, mmmm dd yyyy";
...
if ($("body").data("locale") == 'fr') {
  ...
  Date.abbrMonthNames = ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Août', 'Sept', 'Oct', 'Nov', 'Déc'];
  Date.longFormat = "dddd dd mmmm yyyy";
}
...
(function() {
  ...
  add("longFormat", function() {
    return this.asString(Date.longFormat);
  });
